...
<center> 
<h2>管理员登录</h2>
<form action="${pageContext.request.contextPath}/LoginRegister/adminlogin.action" method="post">
...
<form>
	...
	<input type="radio" name="login" value="教师登录" onclick='javascript:jump2()'/>教师登录
	<input type="radio" name="login" value="管理员登录" checked/>管理员登录
</form>
</div>
</center>
</body>
